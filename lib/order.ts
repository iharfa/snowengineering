...
export function buildOrderText(
  ...
  if (ref) lines.push(`Reference: ${ref} (see /admin → Orders)`);
  lines.push("");
  ...
  lines.push("");
  lines.push(
    "— This message was generated by the snow-engineering.vercel.app order form. Reply here to reach the customer on their own WhatsApp."
  );
  return lines.join("\n");
}
...
export function whatsappLink(
  ...
  return `https://wa.me/${digits}?text=${encodeURIComponent(
    buildOrderText(customer, items, ref)
  )}`;
}
